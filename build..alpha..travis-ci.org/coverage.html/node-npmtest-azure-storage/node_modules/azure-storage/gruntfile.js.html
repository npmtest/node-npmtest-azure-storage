...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-azure-storage/node_modules/azure-storage/gruntfile.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-azure-storage/node_modules/azure-storage/gruntfile.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-azure-storage/node_modules/azure-storage/</a> &#187; gruntfile.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-jsdoc');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-mocha-test');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-devserver');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-nsp');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-contrib-jshint');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('doc', ['jsdoc', 'devserver']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('validate', ['jshint', 'nsp']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('default', ['validate', 'mochaTest']);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
</div>
